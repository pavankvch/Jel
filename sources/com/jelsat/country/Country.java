...
public class Country {
    ...
    public Country(String str, String str2, String str3, int i, boolean z) {
        this.code = str;
        this.name = str2;
        this.dialCode = str3;
        this.flag = i;
        this.isPreferredCountry = z;
    }

    public boolean isPreferredCountry() {
        return this.isPreferredCountry;
    }

    public void setPreferredCountry(boolean z) {
        this.isPreferredCountry = z;
    }
    ...
    public void loadFlagByCode(Context context) {
        if (this.flag == -1) {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder("flag_");
...
*/
        /*
        r3 = this;
        r0 = r3.TAG;	 Catch:{ NullPointerException -> 0x002a }
        r1 = new java.lang.StringBuilder;	 Catch:{ NullPointerException -> 0x002a }
        r2 = "Country->";	 Catch:{ NullPointerException -> 0x002a }
        r1.<init>(r2);	 Catch:{ NullPointerException -> 0x002a }
        r2 = r3.code;	 Catch:{ NullPointerException -> 0x002a }
        r1.append(r2);	 Catch:{ NullPointerException -> 0x002a }
        r2 = ":";	 Catch:{ NullPointerException -> 0x002a }
        r1.append(r2);	 Catch:{ NullPointerException -> 0x002a }
        r2 = r3.dialCode;	 Catch:{ NullPointerException -> 0x002a }
        r1.append(r2);	 Catch:{ NullPointerException -> 0x002a }
        r2 = ":";	 Catch:{ NullPointerException -> 0x002a }
        r1.append(r2);	 Catch:{ NullPointerException -> 0x002a }
        r2 = r3.name;	 Catch:{ NullPointerException -> 0x002a }
        r1.append(r2);	 Catch:{ NullPointerException -> 0x002a }
        r1 = r1.toString();	 Catch:{ NullPointerException -> 0x002a }
        android.util.Log.d(r0, r1);	 Catch:{ NullPointerException -> 0x002a }
        return;
    L_0x002a:
        r0 = r3.TAG;
        r1 = "Null";
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jelsat.country.Country.log():void");
    }

    private static boolean isAlreadyInList(Country country, List<Country> list) {
        if (!(country == null || list == null)) {
            for (Country code : list) {
                if (code.getCode().equalsIgnoreCase(country.getCode())) {
                    return true;
                }
            }
        }
    ...
    public static Country getCountryByDialCode(String str) {
        for (Country country : COUNTRIES) {
            if (str.equalsIgnoreCase(country.getDialCode())) {
                return country;
            }
        }
        return null;
    ...
    public static Country getCountry(Context context) {
        ...
        if (!isPhoneHasSim(telephonyManager.getSimState())) {
            return getCountryByISO(LocaleManager.getDefaultCountry());
        }
        Log.e("sim", telephonyManager.getNetworkCountryIso());
        Log.e("sim", telephonyManager.getNetworkOperatorName());
        Log.e("sim", telephonyManager.getSimCountryIso());
        return getCountryByISO(telephonyManager.getSimCountryIso());
    }

    private static boolean isPhoneHasSim(int i) {
        StringBuilder stringBuilder;
        if (i == 1) {
            String str = SIM_STATE;
            stringBuilder = new StringBuilder("sim absent ");
            ...
            String str2 = SIM_STATE;
            stringBuilder = new StringBuilder("sim state ready ");
            stringBuilder.append(i);
